...
//--------------------------------------------------------------------------
  ...
  /*std::string cstracer("resultados/ndn-with-cache-no-mob/experimento_");
  ...
  std::string appdelaytracer("resultados/ndn-with-cache-no-mob/experimento_");
  ...
  std::string l3agg("resultados/ndn-with-cache-no-mob/experimento_");
  ...
  std::string l2rate("resultados/ndn-with-cache-no-mob/experimento_");
  ...
  std::string l3rate("resultados/ndn-with-cache-no-mob/experimento_");
