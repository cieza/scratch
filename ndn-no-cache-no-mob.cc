...
//--------------------------------------------------------------------------
  ...
  producerHelperAttack.SetPrefix (producerHelperAttack);
...
//--------------------------------------------------------------------------
  ...
  std::string appdelaytracer("resultados/ndn-no-cache-no-mob/experimento_");
  ...
  std::string l3agg("resultados/ndn-no-cache-no-mob/experimento_");
  ...
  std::string l2rate("resultados/ndn-no-cache-no-mob/experimento_");
  ...
  std::string l3rate("resultados/ndn-no-cache-no-mob/experimento_");
